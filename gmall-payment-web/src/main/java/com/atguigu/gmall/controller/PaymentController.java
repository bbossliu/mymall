...
public class PaymentController {
    ...
    public String alipaySubmit(String outTradeNumber, BigDecimal totalAmount, HttpServletRequest request, ModelMap modelMap){
    ...
    /*一下两个参数也可以通过此注释从请求域中获得获得，参考orderController*/
